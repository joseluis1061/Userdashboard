...
const TestVAK = ({ }) => {
  const { user } = useContext(AuthContext ); // Obtén los datos del usuario
      ...
      <div className="w-full max-w-lg">
        ...
        {user && (
          <div className="flex flex-col">
            <p className="text-center text-gray-700 mb-4">Usuario: {user.name}</p>
            <p className="text-center text-gray-700 mb-4">Email: {user.email}</p>
            <p className="text-center text-gray-700 mb-4">Role: {user.role.name_role}</p>
