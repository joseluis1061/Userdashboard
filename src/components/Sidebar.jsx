...
function Sidebar() {
  ...
  return (
    <>
      <div className={`xl:h-[100vh] fixed xl:static w-[80%] md:w-[40%] lg:w-[30%] xl:w-auto h-full top-0 bg-gray-800 p-6 flex flex-col justify-between z-50 ${showMenu ? "left-0" : "-left-full"} transition-all`}>
        ...
        <ul className="flex-1">
          ...
          <li>
            <Link to="/course" className="flex items-center gap-4 py-2 px-4 rounded-lg hover:bg-gray-700 transition-colors text-white">
